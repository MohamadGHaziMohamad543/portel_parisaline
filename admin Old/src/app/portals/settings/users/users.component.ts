...
export class UsersComponent implements OnInit {
  ...
  error = '';
  loading = false;
  titleForm:String="Add Users";
  typeForm:Number=0;
  ControllerPhoto:boolean=true;
  constructor(private base64:Imagebase64Service, private s_Error:SenderrorService, private http:HttpClient,private toastr: ToastrService,private transs:TransService,private formBuilder: FormBuilder,private modalService: NgbModal,private usersService:UsersService) {

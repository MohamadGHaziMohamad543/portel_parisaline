                    ...
                    HTTPs.POST(CONFIG.serverUrl+"/DCA",valueForm).then(res=>{
                        ...
                        if(res.message=="confirm Sucess")
                        {
                            $scope.$apply(()=>{
                                ...
                                $cookies.put('PUC', JSON.stringify({token:$scope.PUC.token,Did:res.user.dentalCenterId,name:res.user.nameDoctor,image:res.user.logo,phone:res.user.phoneNumber,email:res.user.email}));
                                l.stop();
                            });
                        }
                    });

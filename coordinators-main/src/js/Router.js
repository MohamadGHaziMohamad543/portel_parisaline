    ...
    var $StartController=(key)=>{
        ...
        if($ANContreoller[key].Router)
        {
            Routing.config(['$routeProvider', function($routeProvider) {
                ...
                if($ANContreoller[key].Router.Templete)
                {
                    paraRouter['templateUrl']=$ANContreoller[key].Router.Templete;
                }
                if($ANContreoller[key].Router.Render)
                {
                    paraRouter['resolve']={
                        //This function is injected with the AuthService where you'll put your authentication logic
                        'Render' : function(Render){
                            return Render.Render($ANContreoller[key].Router.Render,$ANContreoller[key].Router.AUTH?$ANContreoller[key].Router.AUTH:false);
                        }
                    };
                }
                $routeProvider.when($ANContreoller[key].Router.Url,paraRouter);
                }
            ]);
        }
    }
    ...
    adminApp.directive("dragDrop",function ($rootScope) {

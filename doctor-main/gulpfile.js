...
function dataCopy(){
     gulp.src(folder.src + "data/**/*.css").pipe(gulp.dest(folder.dist_assets + "/data"));
    return gulp.src(folder.src + "data/**/*.js").pipe(gulp.dest(folder.dist_assets + "/data"));
}
// image processing
function imageMin() {
...
function cssDark() {
    gulp
        .src([folder.src + "/scssR/bootstrap.scss"])
        .pipe(sourcemaps.init())
        .pipe(sass()) // scss to css
        .pipe(
            autoprefixer({
        ...
        .pipe(gulp.dest(folder.dist_assets + "cssR/"))
        .pipe(cleanCSS())
        .pipe(
            rename({
                // rename app.css to icons.min.css
        ...
        .pipe(gulp.dest(folder.dist_assets + "cssR/"));
    gulp
        .src([folder.src + "/scssR/icons.scss"])
        .pipe(sourcemaps.init())
        .pipe(sass()) // scss to css
        .pipe(
            autoprefixer({
        ...
        .pipe(gulp.dest(folder.dist_assets + "cssR/"));
    gulp
        .src([folder.src + "/scssR/app-rtl.scss"])
        .pipe(sourcemaps.init())
        .pipe(sass()) // scss to css
        .pipe(
            autoprefixer({
...
function watchFiles() {
    ...
    gulp.watch(folder.src + "scssR/**/*", gulp.series(cssDark, reloadBrowserSync));
    ...
    gulp.watch(folder.src + "data/**/*", gulp.series(dataCopy, reloadBrowserSync));
}

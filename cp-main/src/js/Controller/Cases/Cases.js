...
$ANContreoller.Cases = {
    FUN: ['$scope', '$location', '$routeParams', function ($scope, $location, $routeParams) {
        ...
        $scope.TAB = {
            ...
            printStl: { display: true, set: false, active: false },
            fileStl: { display: true, set: false, active: false },
            attachments: { display: true, set: false, active: false },
        };
    ...
    Router: {
        Url: "/Cases/:id",
        Templete: 'Views/Cases/Cases.html?v=' + versionCash,
        Render: [

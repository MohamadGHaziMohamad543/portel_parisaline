    ...
    $scope.$emit('AuthChanged', true);
        ...
        $scope.addTask=()=>{
            ...
            for(var i=0;i<$scope.Tasks.length;i++)
            {
                ...
                Tasks[i]={templeteId:$scope.Tasks[i].templeteId,userId:$scope.Tasks[i].userId,usertype:$scope.Tasks[i].usertype,action:$scope.Tasks[i].action,Start:$scope.Tasks[i].Start,End:$scope.Tasks[i].End,endTask:$scope.Tasks[i].endTask,commentAdmin:$scope.Tasks[i].commentAdmin,commentUser:$scope.Tasks[i].commentUser}
            }

            Tasks.splice(index,0,{templeteId:$scope.templeteId,userId:$('#UserId').val(),usertype:$("#usertype").val(),action:$("#action").val(),Start:Start,End:null,endTask:null,commentAdmin:$("#CommentInput").val(),commentUser:null});
